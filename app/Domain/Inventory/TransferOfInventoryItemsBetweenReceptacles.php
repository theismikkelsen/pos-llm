...
class TransferOfInventoryItemsBetweenReceptacles
{
    public function __construct(
        ...
        if ($receptacleIdFrom === null && $receptacleIdTo === null) {
            throw new \RuntimeException('Source and destination receptacles cannot both be null');
        }
        if ($receptacleIdFrom !== null && $receptacleIdTo !== null && $receptacleIdFrom === $receptacleIdTo) {
    ...
    public function withArgs(\CodeTooling\OmittedArg|IdAndTenant $idAndTenant = new \CodeTooling\OmittedArg, \CodeTooling\OmittedArg|int $inventoryItemAtLowestDistinctLevelId = new \CodeTooling\OmittedArg, \CodeTooling\OmittedArg|int|null $receptacleIdFrom = new \CodeTooling\OmittedArg, \CodeTooling\OmittedArg|int|null $receptacleIdTo = new \CodeTooling\OmittedArg, \CodeTooling\OmittedArg|int $quantityAdjustment = new \CodeTooling\OmittedArg, \CodeTooling\OmittedArg|CarbonImmutable $timeCreated = new \CodeTooling\OmittedArg): self
    {
